...
2a) If using an Arduino, order the following items:
...
-Wires and solder
2b) If using the [High-Speed Programmable LED Driver](https://github.com/Llamero/Four_Channel_MHz_LED_Driver), the sensor can connect directly to the external thermistor port, so only wire and solder is needed.
